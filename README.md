...
| suite | cases | covers |
|---|---|---|
| `lastlight-review-gate.test.sh` | 185 | what is gated, what is allowed through |
| `lastlight-review-record.test.sh` | 13 | the pass bar and the attestation binding |
| `lastlight-review-run.test.sh` | 75 | flag parsing, the prompt, the defaults, the tool allowlist, and what may cross back out of the sandbox |
