...
| suite | cases | covers |
|---|---|---|
| `lastlight-review-gate.test.sh` | 81 | what is gated, what is allowed through |
| `lastlight-review-record.test.sh` | 12 | the pass bar and the attestation binding |
| `lastlight-review-run.test.sh` | 49 | flag parsing, the prompt, the defaults, and the tool allowlist |
| `lastlight-sandbox.test.sh` | 85 | review isolation and the containment verdict |
| `lastlight-work-sandbox.test.sh` | 115 | work isolation, policy spelling, landing |
